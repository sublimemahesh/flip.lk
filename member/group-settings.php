                                            ...
                                            <div class="panel-heading">
                                                <div class=" row row-1 row-content">
                                                    ...
                                                    <div class="col-xs-9 text-right">
                                                        <div class="huge">
                                                            <?php
                                                            if (count($publisedAds) > 9 || count($publisedAds) == 0) {
                                                                echo count($publisedAds);
                                                            } else {
                                                                echo '0' . count($publisedAds);
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="title">
                                            ...
                                            <div class="panel-heading">
                                                <div class="row row-1 row-content2">
                                                    ...
                                                    <div class="col-xs-9 text-right">
                                                        <div class="huge">
                                                            <?php
                                                            if (count($unpublisedAds) > 9 || count($unpublisedAds) == 0) {
                                                                echo count($unpublisedAds);
                                                            } else {
                                                                echo '0' . count($unpublisedAds);
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="title">
                                            ...
                                            <div class="panel-heading">
                                                <div class="row row-1 row-content1">
                                                    ...
                                                    <div class="col-xs-9 text-right">
                                                        <div class="huge">
                                                            <?php
                                                            if ($member_request > 9 || $member_request == 0) {
                                                                echo $member_request;
                                                            } else {
                                                                echo '0' . $member_request;
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="title">
                                            ...
                                            <div class="panel-heading">
                                                <div class="row row-1 row-content3">
                                                    ...
                                                    <div class="col-xs-9 text-right">
                                                        <div class="huge">
                                                            <?php
                                                            if (count($members) > 9 || count($members) == 0) {
                                                                echo count($members);
                                                            } else {
                                                                echo '0' . count($members);
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="title">
                                                            <a href="members.php?id=<?php echo $id; ?>">Group Members</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
