...
<html> 
    <head>
        ...
        <title>Add New Business Category || Sublime Web Manager</title>
        <!-- Favicon-->
                                ...
                                <form class="form-horizontal"  method="post" action="post-and-get/business-category.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            <input type="submit" name="create" class="btn btn-primary m-t-15 waves-effect" value="Add Business Category"/>
                                        </div>
                                    </div>
                                    <hr/>
                                </form>
