...
<html> 
    <head>
        ...
        <title>Arrange Business Categories || Sublime Web Manager</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Business Categories</h2>
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/business-category.php" class="form-horizontal" >
                                            ...
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($CATEGORY->all()) > 0) {
                                                        foreach ($CATEGORY->all() as $key => $category) {
                                                            ...
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    ...
                                                                    <input type="hidden" name="sort[]"  value="<?php echo $category["id"]; ?>" class="sort-input"/>
                                                        ...
                                                        ?> 
                                                        <b>No business categories in the database.</b> 
                                                    <?php } ?> 
