                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    Manage Boost Requested Advertisements
                                </h2>
                            ...
                            <div class="body">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $ADVERTISEMENT = Advertisement::getBoostRequestedAds();
                                        $i = 1;
                                        if (count($ADVERTISEMENT) > 0) {
                                            foreach ($ADVERTISEMENT as $key => $advertisement) {
                                                ...
                                                <tr id="row_<?php echo $advertisement['id']; ?>">
                                                    ...
                                                    <td><?php echo substr($advertisement['boost_requested_date'], 0, 10); ?></td>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <a href="boost-advertisement.php?id=<?php echo $advertisement['id']; ?>" class="op-link btn btn-sm btn-success" title="Boost Ad">
